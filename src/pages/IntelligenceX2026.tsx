...
export default function IntelligenceX2026() {
  ...
  const institutionLogos = [
    ...
    { abbr: "TUB",    name: "TU Berlin",                                    src: "https://upload.wikimedia.org/wikipedia/commons/4/44/TU_Berlin_Logo.svg",                                    scale: 1.3,          href: "https://www.tu.berlin" },
    ...
    { abbr: "ISI",    name: "International Statistical Institute",          src: isiLogo,                                                                       scale: 1.3,                    href: "https://isi-web.org/" },
